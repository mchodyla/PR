...
int main(){
    ...
    //zadanie_1();
    printf("RUNNING PI's...\n\n");
    run_with_time(num_steps, N_PROC, pi_1);
    run_with_time(num_steps, N_PROC, pi_2);

    /** PI:
        Ilo?? wynik?w : 7 r??nych wersji kodu * | {t_sekwencyjne, t_r?wnoleg?e(n=logiczne), t_r?wnoleg?e(n=fizyczne), t_r?wnoleg?e(n=fizyczne/2)} | = 7 * 4 = 28
